...
cells_4 = [
    ...
    },
    {
        ...
        "source": [
            ...
            "| **Exp #11**| LOFAR (Frequência) | 4000 | 2.0 | PCA (64 comps) | **64.04%** | **± 1.88%** | **Golden LOFAR**. Acurácia robusta aliada a recorde no experimento CPA. |\n"
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            "history = {\n",
            "    'm': [300, 1000, 1000, 2000, 3000, 4000, 4000, 1000, 1000, 2000, 4000],\n",
            "    'Extrator': ['MEL', 'MEL', 'MEL (PCA)', 'MEL', 'MEL', 'MEL', 'MEL (PCA)', 'LOFAR (Sem PCA)', 'LOFAR (PCA)', 'LOFAR (PCA)', 'LOFAR (PCA)'],\n",
            "    'ACC': [61.02, 62.21, 60.14, 62.57, 63.10, 64.56, 63.90, 59.11, 61.92, 61.08, 64.04],\n",
            "    'std': [1.94, 1.90, 1.24, 2.05, 1.97, 1.18, 1.47, 2.60, 1.89, 1.80, 1.88]\n",
            "}\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "\n",
            "# Plotagem do ponto isolado exploratório LOFAR Sem PCA\n",
