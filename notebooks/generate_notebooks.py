...
cells_4 = [
    ...
    },
    {
        ...
        "source": [
            ...
            "| **Exp #9** | LOFAR (Frequência) | 1000 | 2.0 | PCA (64 comps) | 61.92% | ± 1.89% | LOFAR com PCA64 ativado (aumento drástico de robustez e acurácia). |\n",
            "| **Exp #10**| LOFAR (Frequência) | 2000 | 2.0 | PCA (64 comps) | 61.08% | ± 1.80% | LOFAR intermediário em escala 2000. |\n",
            "| **Exp #11**| LOFAR (Frequência) | 4000 | 2.0 | Sem PCA | 62.74% | ± 2.52% | LOFAR em alta escala sem redução linear (saturação de ruído espectral). |\n",
            "| **Exp #12**| LOFAR (Frequência) | 4000 | 2.0 | PCA (64 comps) | **64.04%** | **± 1.88%** | **Golden LOFAR**. Acurácia robusta aliada a recorde no experimento CPA. |\n"
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            "history = {\n",
            "    'm': [300, 1000, 1000, 2000, 3000, 4000, 4000, 1000, 1000, 2000, 4000, 4000],\n",
            "    'Extrator': ['MEL', 'MEL', 'MEL (PCA)', 'MEL', 'MEL', 'MEL', 'MEL (PCA)', 'LOFAR (Sem PCA)', 'LOFAR (PCA)', 'LOFAR (PCA)', 'LOFAR (Sem PCA)', 'LOFAR (PCA)'],\n",
            "    'ACC': [61.02, 62.21, 60.14, 62.57, 63.10, 64.56, 63.90, 59.11, 61.92, 61.08, 62.74, 64.04],\n",
            "    'std': [1.94, 1.90, 1.24, 2.05, 1.97, 1.18, 1.47, 2.60, 1.89, 1.80, 2.52, 1.88]\n",
            "}\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "plt.errorbar(lofar_no_pca_data['m'], lofar_no_pca_data['ACC'], yerr=lofar_no_pca_data['std'], fmt='x:', \n",
