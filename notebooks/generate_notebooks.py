...
cells_2 = [
    ...
    },
    {
        ...
        "source": [
            "rejection_data = {\n",
            "    'Threshold': [0.0, 0.5, 0.6, 0.8, 0.9],\n",
            "    'LOFAR_SVM_Cov': [100.0, 78.25, 61.21, 35.04, 22.27],\n",
            "    'LOFAR_SVM_ACC': [63.32, 70.36, 76.54, 86.75, 90.43],\n",
            "    'MEL_SVM_Cov': [100.0, 89.67, 76.07, 51.28, 37.48],\n",
            "    'MEL_SVM_ACC': [64.56, 66.23, 69.60, 77.70, 83.42],\n",
            "    'CNN_Cov': [100.0, 95.93, 82.90, 69.30, 54.01],\n",
            "    'CNN_ACC': [65.01, 63.18, 66.61, 69.77, 74.39],\n",
            "    'MLP_Cov': [100.0, 85.60, 70.36, 45.37, 32.90],\n",
            "    'MLP_ACC': [63.54, 67.41, 71.97, 80.29, 85.93]\n",
            "}\n",
            "\n",
