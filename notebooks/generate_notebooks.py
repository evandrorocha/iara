...
cells_2 = [
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Discussão Física por Alvo Acústico:\n",
            "1. **LARGE & BACKGROUND (Alta Confiança):** O SVM atinge acurácia excepcional superior a **95%** para alvos grandes e ruído de fundo. Navios de grande porte possuem alta assinatura de cavitação e maquinário nítido, enquanto o silêncio de fundo não apresenta modulação periódica. O modelo classifica com segurança e acerto extremo.\n",
            "2. **MEDIUM (O Consenso Seguro):** Com um aproveitamento de **82.9%**, navios de porte médio têm Relação Sinal-Ruído intermediária. O filtro temporal rejeita sabiamente a maioria das janelas ambíguas, preservando apenas trânsitos altamente consolidados.\n",
            "3. **SMALL (Limitação Física de Detecção):** Embarcações de baixo calado produzem assinaturas fracas que se confundem facilmente com o mar aberto. O modelo age de forma prudente ao classificar apenas **7.4%** desses trânsitos, atenuando falsos positivos operacionais.\n"
        ]
    }
]
