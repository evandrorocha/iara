    ...
    \begin{columns}[t]
        ...
        \begin{block}{\small Efici\^{e}ncia Computacional}
            ...
            \begin{itemize}
                ...
                \item Alta precis\~{a}o ($>83\%$) previne falsos alarmes ao confirmar se o navio \'{e} realmente LARGE.
            \end{itemize}
        \end{block}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[t]
        ...
        \begin{block}{\small 1. Fus\~{a}o de Caracter\'{i}sticas (264-D)}
            ...
            \begin{itemize}
                ...
                \item \textbf{Papel do PCA-8:} Comprime o LOFAR de 1.024 para as 8 componentes mais informativas, evitando sobreajuste e excesso de ru\'{i}do.
            \end{itemize}
        \end{block}
        ...
        \begin{block}{\small 2. Roteamento em Cascata}
            ...
            \begin{itemize}
                \setlength{\itemsep}{2pt}
                \item \textbf{Acionamento:} Ativado \textbf{apenas} se o modelo base prediz a classe \textbf{LARGE}.
                \item \textbf{Resgate para SMALL:} O especialista bin\'{a}rio reavalia o \'{a}udio; se n\~{a}o confirmar LARGE, reclassifica como \textbf{SMALL} (resgatando 31 \'{a}udios).
            \end{itemize}
        \end{block}
    \end{columns}
\end{frame}
