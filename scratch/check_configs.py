...
print("=" * 80)
print("INSPECTING EXPERIMENT CONFIGURATIONS (UTF-8 MODE)")
print("=" * 80)

for path in glob.glob('results/trainings/tests/**/*.json', recursive=True):
    with open(path, encoding='utf-8') as f:
        try:
            ...
            # Print using safe representations to avoid console glitches
